...
Периодически обновляемые списки IP-адресов с открытым портом 443 для российских и СНГ-провайдеров. Можно использовать как whitelist в роутере/файрволе или для проверки есть ли ваш IP в бс ( но для этого лучше подойдет [наш бот](https://t.me/olcwlybot) или [наш API](https://wly.zarazaex.xyz/check?ip=1.1.1.1) который в актуальном времени проверяет отвечает ли ваш IP с реальной симки )
